...
def counters():
	global boxes1, boxes2, boxes3, boxes4, boxes5, boxes6, boxes7
	boxes1 = pygame.sprite.RenderUpdates()
	slider_strength= boxes1.add(slider1([255, 0, 0], [40, 235]))
	boxes2 = pygame.sprite.RenderUpdates()
	slider_intelligence= boxes2.add(slider2([255, 0, 0], [112, 235]))
	boxes3 = pygame.sprite.RenderUpdates()
	slider_habitat= boxes3.add(slider3([255, 0, 0], [185, 235]))
	boxes4 = pygame.sprite.RenderUpdates()
	slider_demeanor= boxes4.add(slider4([255, 0, 0], [259, 235]))
	boxes5 = pygame.sprite.RenderUpdates()
	slider_comp = boxes5.add(slider5([0, 255, 0], [670, 400]))
	boxes6 = pygame.sprite.RenderUpdates()
	slider_mat = boxes6.add(slider6([0, 255, 0], [670, 440]))
	boxes7 = pygame.sprite.RenderUpdates()
	slider_dev = boxes7.add(slider7([0, 255, 0], [670, 480]))
...
def shuffledeal():
	...
	card1 = Card((11,deal_area_y), 'bear.png', 10, -5, 10, 5, "hawk", -15,5,5, 0)
	card2 = Card((155,deal_area_y), 'deer.png', 10, 15, -20, 10, "tiger", 0, -15,-10,0)
	card3 = Card((295,deal_area_y), 'elephant.png', -10, -10, -20, 15, "octopus", 0, 5, -10, 0)
	card4 = Card((438,deal_area_y), 'fox.png', 10, 10, -20, 20, "resource", 10, 10, 10, 0)
	card5 = Card((11,deal_area_y), 'gazelle.png', -10, -5, 10, 5, "hawk", -15,0,-5, 0)
	card6 = Card((155,deal_area_y), 'gorilla.png', 10, 15, 20, 10, "tiger", 5, -15,0,0)
	card7 = Card((295,deal_area_y), 'greyhound.png', -10, 10, -20, 15, "octopus", 5, 0, -10, 0)
	card8 = Card((438,deal_area_y), 'shark.png', 10, 0, 5, 20, "resource", 10, 10, 10, 0)
	card9 = Card((11,deal_area_y), 'warthog.png', -10, -5, 10, 5, "hawk", -15,0,5, 0)
	card10 = Card((155,deal_area_y), 'wolf.png', 10, 15, -20, 10, "tiger", 5, -15,0,0)
	card11 = Card((295,deal_area_y), 'snakehead.png', -10, -10, -20, 15, "octopus", 5, 0, -10, 0)
	card12 = Card((438,deal_area_y), 'ostrich.png', 10, 10, -20, 20, "resource", 10, 10, 10, 0)
	card13 = Card((11,deal_area_y), 'python.png', -10, -5, 10, 5, "hawk", -15,0,10, 0)
	card14 = Card((155,deal_area_y), 'tiger.png', 10, 15, 20, 10, "tiger", 0, -15,5,0)
	card15 = Card((295,deal_area_y), 'coopershawk.png', -10, 10, -20, 15, "octopus", 5, 0, -10, 0)
