...
def findRecognizedCol(parsed):
    ...
    fname_list =['First', 'FIRST', 'Fname', 'First Name', 'FIRSTNAME']
    lname_list = ['Last', 'LAST', 'Lname', 'Last Name', 'LASTNAME']
...
#MISC
#while read in; do python3 init.py -fv "$in" test striders.sqlite3; done < mcrrc.txt
