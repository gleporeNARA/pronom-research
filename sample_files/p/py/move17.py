...
def shuffledeal():
	...
	card1 = Card((8,deal_area_y), 'hawk.png', -5, -5, 10, "air", "hawk", -15,0,0, 0)
	card2 = Card((152,deal_area_y), 'tiger.png', 15, 15, -20, "land", "tiger", 0, -15,0,0)
	card3 = Card((292,deal_area_y), 'octopus.png', 20, -10, -20, "water", "octopus", 0, 0, -10, 0)
	card4 = Card((435,deal_area_y), 'resource.png', 20, 10, -20, "water", "resource", 10, 10, 10, 0)
	card5 = Card((8,deal_area_y), 'hawk1.png', -5, -5, 10, "air", "hawk", -15,0,0, 0)
	card6 = Card((152,deal_area_y), 'tiger1.png', 15, 15, 20, "land", "tiger", 0, -15,0,0)
	card7 = Card((292,deal_area_y), 'octopus1.png', 20, 10, -20, "water", "octopus", 0, 0, -10, 0)
	card8 = Card((435,deal_area_y), 'resource1.png', 0, 0, 5, "space", "resource", 10, 10, 10, 0)
