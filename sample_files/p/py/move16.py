...
class Slider(pygame.sprite.Sprite):
	def __init__(self,  image):
		...
		self.image, self.rect = load_png('horred.png')
...
def counters():
	...
	#player = pygame.image.load('horred.png').convert()
	...
	slider_strength = Slider(('horred.png')) #color of slider
	slider_intelligence = Slider(('horred.png')) #color of slider
	slider_demeanor = Slider(('horred.png')) #color of slider
	slider_comp = Slider(('horred.png')) #color of slider, plus height and width
	slider_mat = Slider(('horred.png')) #color of slider
	slider_dev = Slider(('horred.png')) #color of slider
	...
	screen.blit(slider_comp.image, ((default_comp_height + total_comp),425))
	screen.blit(slider_mat.image, ((default_mat_height + total_mat), 475))
	screen.blit(slider_dev.image, ((default_dev_height + total_dev), 525))
...
def add(card1_strength, card2_strength, card3_strength, card4_strength, card1_intelligence, card2_intelligence, card3_intelligence, card4_intelligence, card1_demeanor, card2_demeanor, card3_demeanor, card4_demeanor, card1_moved, card2_moved, card3_moved, card4_moved, card1_name, card2_name, card3_name, card4_name, card1_comp, card2_comp, card3_comp, card4_comp, card1_mat, card2_mat, card3_mat, card4_mat, card1_dev, card2_dev, card3_dev, card4_dev):
	...
	screen.blit(slider_strength.image, (45,(default_strength_height + total_strength)))	
	screen.blit(slider_intelligence.image, (115,(default_intelligence_height + total_intelligence)))
	screen.blit(slider_demeanor.image, (200,(default_demeanor_height + total_demeanor)))
	...
	#screen.fill ((255, 255, 255), (750, 0, 50, 30))#clear moves area
	#screen.fill ((255, 255, 255), (65, 35, 50, 20))#clear strength area
	#screen.fill ((255, 255, 255), (155, 35, 50, 20))#clear intelligence area
	#screen.fill ((255, 255, 255), (255, 35, 50, 20))#clear demeanor area
	#screen.fill ((255, 255, 255), (755, 435, 50, 20))#clear comp area
	#screen.fill ((255, 255, 255), (755, 495, 50, 20))#clear mat area
	#screen.fill ((255, 255, 255), (755, 545, 50, 20))#clear dev area
...
def shuffledeal():
	...
	card1 = Card((8,390), 'hawk.png', -5, -5, 10, "air", "hawk", -1155,155,155, 0)
	card2 = Card((152,390), 'tiger.png', 15, 15, -20, "land", "tiger", 0, -1155,155,155)
	card3 = Card((292,390), 'octopus.png', 20, -10, -20, "water", "octopus", 0, 0, -10, 0)
	card4 = Card((435,390), 'octopus.png', 20, 10, -20, "water", "octopus", 0, 0, -10, 0)
	card5 = Card((8,390), 'hawk1.png', -5, -5, 10, "air", "hawk", -1155,155,155, 0)
	card6 = Card((152,390), 'tiger1.png', 15, 15, 20, "land", "tiger", 0, -1155,155,155)
	card7 = Card((292,390), 'octopus1.png', 20, 10, -20, "water", "octopus", 0, 0, -10, 0)
	card8 = Card((435,390), 'resource1.png', 0, 0, 5, "space", "resource", 10, 10, 20, 0)
	...
	while 1:
		...
		for event in pygame.event.get():
			if event.type is KEYDOWN and event.key == K_1: #play first card
				...
				card1_dealt.rect.topleft = (583,143)
				screen.fill ((0,0,0), (8,390, 110, 160))
			...
			if event.type is KEYDOWN and event.key == K_2:#play second card
				card2_dealt.rect.topleft = (583,143)
				screen.fill ((0,0,0), (152,390, 110, 160))
			...
			if event.type is KEYDOWN and event.key == K_3:#play third card
				card3_dealt.rect.topleft = (583,143)
				screen.fill ((0,0,0), (292,390, 110, 160))
			...
			if event.type is KEYDOWN and event.key == K_4:#play fourth card
				card4_dealt.rect.topleft = (583,143)
				screen.fill ((0,0,0), (435,390, 110, 160))
			...
			if event.type is KEYDOWN and event.key == K_0:#0 resets any move made
				screen.fill ((0,0,0), (583,143, 110, 160))
				screen.fill ((0,0,0), (8,390, 110, 160))
				screen.fill ((0,0,0), (152,390, 110, 160))
				screen.fill ((0,0,0), (292,390, 110, 160))
				screen.fill ((0,0,0), (435,390, 110, 160))
