...
### RUN: python3 init.py -f -v https://www.mcrrc.org/race-results/2018/06/mcrrc-suds-soles-5k/ test striders.sqlite3###
...
### ADD SECTIONS TO PARSE CHRONOTRACKS, ATHLINKS, AND SPORTHIVE PAGES TO PYTHON LIST VARIABLE CALLED parsed ###
### IF NECESSARY, ADD HEURISTIC DETECTION OF COLUMNS WHICH AREN'T TITLED NORMALLY (I'VE GOT THIS ROUGHED IN) ###
### FIGURE OUT HOW TO PARSE RESULTS WITH MULTIPLE "PLACE" ROWS AND BLANK ROWS ###
### STRIP AWARDS SECTION, FIND LARGEST CONTINUAL SET OF ROWS OF DATA WITHOUT A LINE BREAK, THAT'S THE RESULTS, NOT THE AWARDS ###
...
def main(pages):
    ...
    for page in pages:
        ...
        elif 'charmcity' in str(pages) in str(pages):
            print ("FOUND CHARM CITY RESULTS")
            #PUSH TO CHARM CITY RESULTS PULLER                
            race_type = "charmcity_type"     
            
##### RACES WE NEED PARSERS FOR AND THEIR LOCATIONS #####
##### Cherry Blossom 10 Miler - xacte - http://results.xacte.com/?kw=cucb
##### Marine Corps Marathon - xacte - http://www.marinemarathon.com/results/marathon
...
##### Boston Marathon - baa.org - http://registration.baa.org/2018/cf/Public/iframe_ResultsSearch.cfm?mode=entry
##### Maryland Half - racinemultisports - http://racinemultisports.com/results-mdhalfand5k-2018/#/race/6KQ3mS/1/
##### EC5K and EC10K - active.com - https://resultscui.active.com/events/NEWEllicottCity5K10K
##### Philly Half - rocknroll - http://www.runrocknroll.com/finisher-zone/search-and-results/?eventid=56
...
##### Chicago Marathon - own site - http://results.chicagomarathon.com/2017/?pid=search
##### NYC Marathon - own site - https://results.nyrr.org/event/M2017/finishers
        ...
        if ('.txt' in str(pages) or '.TXT' in str(pages) or pre and pre_bytes_length > table_bytes_length):
            ...
            ###############################
            ### DELETE BLANK LINES AND EXTRA "PLACE" LINES HERE
...
####PRE TAGS   http://www.brrc.com/fathers-day-5k##########
####PRE TAGS   http://www.brrc.com/frozen-finger-5-miler-4
####PRE TAGS   http://www.brrc.com/loch-raven-8-miler-0
####PRE TAGS   http://www.brrc.com/womens-distance-festival-12 (short list)
####PLAIN TEXT http://www.mdtiming.com/2018/BRRC-FF2018results.TXT    #############
####TABLE      http://www.brrc.com/gunpowder-keg-ultra-trail-races-7     #####


### RESULTS WITH ISSUES ###
### http://www.brrc.com/ncr-trail-half-marathon multiple Place lines

#ANNAPOLIS RESULTS

#https://www.annapolisstriders.org/result/2018-dawsons-fathers-day-10k-results/
#https://www.annapolisstriders.org/result/2018-cherry-pit-10-mile-race-results/
...
#MISC
#while read in; do python3 init.py "$in"; done < mcrrc.txt
