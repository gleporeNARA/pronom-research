...
def counters():
	global slider_strength, slider_intelligence, slider_habitat, slider_demeanor, slider_comp, slider_mat, slider_dev, ballsprite
	...
	slider_comp = slider1([670, 400])
	slider_mat = slider1([670, 440])
	slider_dev = slider1([670, 480])
	ballsprite = pygame.sprite.RenderPlain(slider_strength, slider_intelligence, slider_habitat, slider_demeanor, slider_comp, slider_mat, slider_dev)
...
class slider1(pygame.sprite.Sprite):
	...
	def update(self, card, amt):
		...
		screen.blit(backgroundimg, card.rect, card.rect)
		card.rect.top += amt
		ballsprite.draw(screen)
...
def move_sliders(card1_moved, card2_moved, card3_moved, card4_moved):
	if (card1_moved == 1):
		...
		slider1.update(slider_comp, slider_comp, card1_dealt.comp)
		slider1.update(slider_mat, slider_mat, card1_dealt.mat)
		slider1.update(slider_dev, slider_dev, card1_dealt.dev)
	if (card2_moved == 1):
		...
		slider1.update(slider_comp, slider_comp, card2_dealt.comp)
		slider1.update(slider_mat, slider_mat, card2_dealt.mat)
		slider1.update(slider_dev, slider_dev, card2_dealt.dev)
	if (card3_moved == 1):
		...
		slider1.update(slider_comp, slider_comp, card3_dealt.comp)
		slider1.update(slider_mat, slider_mat, card3_dealt.mat)
		slider1.update(slider_dev, slider_dev, card3_dealt.dev)
	if (card4_moved == 1):
		#print "card3 dealt moved"
		...
		slider1.update(slider_comp, slider_comp, card4_dealt.comp)
		slider1.update(slider_mat, slider_mat, card4_dealt.mat)
		slider1.update(slider_dev, slider_dev, card4_dealt.dev)
