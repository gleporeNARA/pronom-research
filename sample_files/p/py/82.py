...
for j in columns: 
    ...
    print("\nProcesing column " + str(j) + " as " + str(convert))
...
df.to_csv(r'DB26T_1982.csv', index=False,sep = '|')

#df.to_excel(r'TRAFFIC_1962-1970b.xlsx', index=False)
#ILLEGAL_CHARACTERS_RE = re.compile(r'[\000-\010]|[\013-\014]|[\016-\037]')
#df=df.applymap(lambda x: ILLEGAL_CHARACTERS_RE.sub(r'XXX', x) if isinstance(x, str) else x)
