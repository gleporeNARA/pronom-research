...
def battle(card1_moved):
	
	if (card1_moved == 1):
		attacker = card1_strength
		
		if (attacker > card2_strength):
			card1_sprite_position.left = 0
			card1_sprite_position.top = 0
			card2_sprite_position.top = card2_default_top
			card2_sprite_position.left = card2_default_left
			screen.blit(background, (0,0))
			pygame.display.flip() 
		else:
			card2_sprite_position.left = 0
			card2_sprite_position.top = 0
			card1_sprite_position.top = card1_default_top
			card1_sprite_position.left = card1_default_left
			screen.blit(background, (0,0))
			pygame.display.flip() 
