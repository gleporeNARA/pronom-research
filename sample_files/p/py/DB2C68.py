...
for line in Lines:
    ...
    print("F5" + str(int(Filler5, 16)))
    f.write(str(int(Filler5, 16)))
    #print(Filler5)
    #f.write(str((Filler5)))
    f.write("|")
