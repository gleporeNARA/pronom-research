...
for j in columns: 
    ...
    print("Processing column " +str(colcount) + " of " + str(len(colnames)) + " - " + str(j) + " as " + str(convert))
...
#df.to_excel(writer,'Sheet1') # it is called here to write the excel sheet
