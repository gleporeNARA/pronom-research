...
def add(card1_strength, card2_strength, card3_strength, card4_strength, card1_intelligence, card2_intelligence, card3_intelligence, card4_intelligence, card1_habitat, card2_habitat, card3_habitat, card4_habitat, card1_demeanor, card2_demeanor, card3_demeanor, card4_demeanor, card1_ability, card2_ability, card3_ability, card4_ability, card1_moved, card2_moved, card3_moved, card4_moved, card1_name, card2_name, card3_name, card4_name, card1_comp, card2_comp, card3_comp, card4_comp, card1_mat, card2_mat, card3_mat, card4_mat, card1_dev, card2_dev, card3_dev, card4_dev):
	...
	screen.fill ((0,0,0), (45, 362, 25, 15))#clear strength area
	screen.fill ((0,0,0), (115, 362, 20, 15))#clear intelligence area
	screen.fill ((0,0,0), (185, 362, 20, 15))#clear habitat area
	screen.fill ((0,0,0), (265, 362, 20, 15))#clear demeanor area
	screen.fill ((0,0,0), (333, 362, 20, 15))#clear ability area
	screen.fill ((0,0,0), (755, 400, 25, 15))#clear comp area
	screen.fill ((0,0,0), (755, 440, 25, 15))#clear mat area
	screen.fill ((0,0,0), (755, 480, 25, 15))#clear dev area
...
def check_resources(total_comp, total_mat, total_dev):
	#screen.blit(backgroundimg, caution1.rect)
	caution1 = caution([580,520])
	caution2 = caution([600,520])
	caution3 = caution([620,520])
	if total_comp <= 90:
...
class time_counter(pygame.sprite.Sprite):
	def __init__(self, initial_position):
		pygame.sprite.Sprite.__init__(self)
		self.image, self.rect = load_png("50.png")
		self.rect.topleft = initial_position
...
counter_time = time_counter([70, 90])
screen.blit(counter_time.image, counter_time.rect)
pygame.display.update()
#pygame.time.wait(2000)
#screen.blit(backgroundimg, counter_time.rect, counter_time.rect)
#pygame.display.update()
...
class slider2(pygame.sprite.Sprite):
	...
	def update(self, card, amt):
		...
		screen.blit(backgroundimg, slider_comp.rect, slider_comp.rect)#remove initial image from screen
