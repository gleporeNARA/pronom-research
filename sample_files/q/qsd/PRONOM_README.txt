...
To be sure of a good backup ( although i do like the save a copy as feature )

go to

file / backup restore / backup

and let the quicken create its own backup file on the flash drive

it will have either a .qdb or a .qdf backup extension depending on the year of the quicken

 

That file will definately contain all that quicken needs to restore your data.

https://www.justanswer.com/accounting-software/63x06-saved-latest-update-quicken-files-backup-file.html
