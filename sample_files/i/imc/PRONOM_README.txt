...
As you might guess: MOVIE* files contain movies (in SMUSH format), VOX* files contains voice and lipsync files, *MUS* files contain music in (IMC format), and DATA* files contain everything else...

https://forums.scummvm.org/viewtopic.php?t=15530
