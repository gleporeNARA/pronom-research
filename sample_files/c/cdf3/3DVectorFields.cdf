...
NotebookDataLength[     75797,       1486]
NotebookOptionsPosition[     48889,        909]
NotebookOutlinePosition[     75132,       1470]
CellTagsIndexPosition[     75021,       1464]
WindowTitle->3D Vector Fields
WindowFrame->Normal*)
...
Cell["3D Vector Fields", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`boxedQ$$ = 
    True, $CellContext`field$$ = {-#2, -#3, #}& , \
$CellContext`howmanyvectors$$ = 4, $CellContext`vectorstyle$$ = "Arrow3D", 
...
{{
       Hold[$CellContext`boxedQ$$], True, "boxed"}, {True, False}}, {{
       Hold[$CellContext`vectorstyle$$], "Arrow3D", "vector style"}, {
      Automatic -> "flat arrow", "Arrow3D" -> "3D arrow", "Segment" -> 
       "segment"}}, {{
       Hold[$CellContext`howmanyvectors$$], 4, "vector density"}, {
      4 -> "coarse", 8 -> "medium"}}}, Typeset`size$$ = {350., {173., 177.}}, 
    Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`field$184485$$ = False, $CellContext`boxedQ$184486$$ = 
    False, $CellContext`vectorstyle$184487$$ = 
    False, $CellContext`howmanyvectors$184488$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`boxedQ$$ = 
        True, $CellContext`field$$ = {-#2, -#3, #}& , \
$CellContext`howmanyvectors$$ = 4, $CellContext`vectorstyle$$ = "Arrow3D"}, 
      "ControllerVariables" :> {
        Hold[$CellContext`field$$, $CellContext`field$184485$$, False], 
        Hold[$CellContext`boxedQ$$, $CellContext`boxedQ$184486$$, False], 
        Hold[$CellContext`vectorstyle$$, $CellContext`vectorstyle$184487$$, 
         False], 
        Hold[$CellContext`howmanyvectors$$, \
$CellContext`howmanyvectors$184488$$, False]}, 
      "OtherVariables" :> {
...
$CellContext`z}], {$CellContext`x, -3, 3}, {$CellContext`y, -3, 
        ...
        True, Boxed -> $CellContext`boxedQ$$, Ticks -> 
        If[$CellContext`boxedQ$$, None, Automatic], 
        Axes -> $CellContext`boxedQ$$, 
        VectorPoints -> $CellContext`howmanyvectors$$, 
        VectorStyle -> $CellContext`vectorstyle$$, VectorScale -> {Automatic, 
          Scaled[0.4], Automatic}, VectorColorFunction -> "FallColors", 
        ImageSize -> {350, 350}], 
      "Specifications" :> {{{$CellContext`field$$, {-#2, -#3, #}& }, {({#, \
#2, #3}& ) -> 
          TraditionalForm[{$CellContext`x, $CellContext`y, $CellContext`z}], \
({#, #3, -#2}& ) -> 
          TraditionalForm[{$CellContext`x, $CellContext`z, $CellContext`y}], \
...
$CellContext`x}]}}, {{$CellContext`boxedQ$$, True, "boxed"}, {
         True, False}}, {{$CellContext`vectorstyle$$, "Arrow3D", 
          "vector style"}, {
         Automatic -> "flat arrow", "Arrow3D" -> "3D arrow", "Segment" -> 
          "segment"}, ControlPlacement -> 
         Left}, {{$CellContext`howmanyvectors$$, 4, "vector density"}, {
         4 -> "coarse", 8 -> "medium"}, ControlPlacement -> Left}}, 
      "Options" :> {}, "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{618., {224., 229.}},
...
Cell["\<\
Even simple three-dimensional vector fields, like the linear ones here, can \
produce quite complicated pictures. \
\>", "ManipulateCaption"],
...
Cell[TextData[{
 ButtonBox["Vector Field",
  ...
  ButtonNote->"http://mathworld.wolfram.com/VectorField.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
3DVectorFields&version=0009"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/3DVectorFields/3DVectorFields-source.\
...
Cell[TextData[{
 "\"",
 ButtonBox["3D Vector Fields",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/3DVectorFields/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/3DVectorFields/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/3DVectorFields/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/3DVectorFields/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/3DVectorFields/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39451, 681, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[39712, 690, 1761, 40, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[48067, 884, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 74735, 1453},
 {"Copyright", 74930, 1458}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34951, 592, 4343, 82, 70, "Output",
 CellID->154353044],
Cell[39297, 676, 151, 3, 70, "ManipulateCaption"],
Cell[39451, 681, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[39712, 690, 1761, 40, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41476, 732, 44, 0, 70, "RelatedLinksSection"],
Cell[41523, 734, 624, 21, 70, "RelatedLinks",
 CellID->4565618],
Cell[42150, 757, 4781, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[46934, 848, 45, 0, 70, "CitationSection"],
Cell[46982, 850, 749, 20, 70, "Citations"],
Cell[47734, 872, 330, 10, 70, "Author"],
Cell[48067, 884, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature dRqQee7Eq3HQ9vmAu1G0UYhN *)
