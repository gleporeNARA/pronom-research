...
NotebookDataLength[     84272,       1724]
NotebookOptionsPosition[     57898,       1152]
NotebookOutlinePosition[     84157,       1713]
CellTagsIndexPosition[     84046,       1707]
WindowTitle->Area of a Normal Distribution
WindowFrame->Normal*)
...
Cell["Area of a Normal Distribution", "DemoTitle",
 CellID->700863240],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`format$$ = 
    False, $CellContext`z$$ = -1, $CellContext`\[Mu]$$ = 
    15, $CellContext`\[Sigma]$$ = 2, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`\[Mu]$$], 15}, -2, 15, 1}, {{
       Hold[$CellContext`\[Sigma]$$], 2}, 0.6, 3, 0.1}, {{
       Hold[$CellContext`z$$], -1}, -3.4, 3.4, 0.01}, {{
       Hold[$CellContext`format$$], False, "large format"}, {False, True}}}, 
    Typeset`size$$ = {480., {146., 151.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`\[Mu]$11463$$ = 0, $CellContext`\[Sigma]$11464$$ = 
    0, $CellContext`z$11465$$ = 0, $CellContext`format$11466$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`format$$ = 
        False, $CellContext`z$$ = -1, $CellContext`\[Mu]$$ = 
        15, $CellContext`\[Sigma]$$ = 2}, "ControllerVariables" :> {
        Hold[$CellContext`\[Mu]$$, $CellContext`\[Mu]$11463$$, 0], 
        Hold[$CellContext`\[Sigma]$$, $CellContext`\[Sigma]$11464$$, 0], 
        Hold[$CellContext`z$$, $CellContext`z$11465$$, 0], 
        Hold[$CellContext`format$$, $CellContext`format$11466$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`color1$ = 
         RGBColor[0.33, 0.36, 0.78], $CellContext`color2$ = 
         RGBColor[0.12, 0.61, 0.78]}, 
        Show[{
          Plot[
           PDF[
            
            NormalDistribution[$CellContext`\[Mu]$$, \
$CellContext`\[Sigma]$$], $CellContext`x], {$CellContext`x, \
$CellContext`\[Mu]$$ + $CellContext`z$$ $CellContext`\[Sigma]$$, \
$CellContext`\[Mu]$$ + 3.5 $CellContext`\[Sigma]$$}, Filling -> Axis, 
           FillingStyle -> {
             Opacity[0.8], $CellContext`color1$}], 
          Plot[
           PDF[
            NormalDistribution[
            0, 1], $CellContext`x], {$CellContext`x, $CellContext`z$$, 3.5}, 
...
$CellContext`\[Sigma]$$], $CellContext`x], {$CellContext`x, \
$CellContext`\[Mu]$$ - 
            3.5 $CellContext`\[Sigma]$$, $CellContext`\[Mu]$$ + \
$CellContext`z$$ $CellContext`\[Sigma]$$}, Filling -> Axis, FillingStyle -> {
             Opacity[0.8], $CellContext`color2$}], 
          Plot[
           PDF[
            NormalDistribution[
            0, 1], $CellContext`x], {$CellContext`x, -3.5, $CellContext`z$$}, 
           Filling -> Axis, FillingStyle -> {
             Opacity[0.8], $CellContext`color2$}], 
          Graphics[{
            Text["Area", {$CellContext`z$$, 0.7}], $CellContext`color1$, 
            Arrow[{{$CellContext`z$$, 0.6}, {$CellContext`z$$ + 2, 0.6}}], 
            Text[
             ToString[1 - N[
               CDF[
                NormalDistribution[
                0, 1], $CellContext`z$$]]], {$CellContext`z$$ + 2.25, 
              0.65}], $CellContext`color2$, 
            Arrow[{{$CellContext`z$$, 0.6}, {$CellContext`z$$ - 2, 0.6}}], 
            Text[
             ToString[
              N[
               CDF[
                NormalDistribution[
                0, 1], $CellContext`z$$]]], {$CellContext`z$$ - 2.25, 0.65}], 
            GrayLevel[0.8], 
            Line[{{$CellContext`z$$, 0.65}, {$CellContext`z$$, 
               PDF[
                NormalDistribution[0, 1], $CellContext`z$$]}}], 
            AbsolutePointSize[3], 
            RGBColor[0.33, 0.36, 0.78], 
            Table[
             Point[{$CellContext`i, -0.0075}], {$CellContext`i, -3, 3}], 
            Text[
             StringJoin["z = ", 
              ToString[$CellContext`z$$]], {$CellContext`z$$, -0.08}], 
            AbsolutePointSize[4], 
            RGBColor[1, 0.47, 0], 
            Table[
             
             Point[{$CellContext`\[Mu]$$ + $CellContext`i $CellContext`\
\[Sigma]$$, -0.0075}], {$CellContext`i, -3, 3}], 
            Text[
             StringJoin["x = ", 
              
              ToString[$CellContext`\[Mu]$$ + $CellContext`z$$ $CellContext`\
\[Sigma]$$]], {$CellContext`\[Mu]$$ + $CellContext`z$$ \
$CellContext`\[Sigma]$$, -0.08}], Black, 
            Point[{0, -0.0075}], 
            Point[{$CellContext`\[Mu]$$, -0.0075}], 
            Text[
             StringJoin["N(", 
              ToString[$CellContext`\[Mu]$$], ",", 
              ToString[$CellContext`\[Sigma]$$], ")"], {$CellContext`\[Mu]$$, 
              0.05 + PDF[
                
                NormalDistribution[$CellContext`\[Mu]$$, \
$CellContext`\[Sigma]$$], $CellContext`\[Mu]$$]}], 
            Text["N(0,1)", {0, 0.05 + PDF[
                NormalDistribution[0, 1], 0]}], 
            
            Line[{{$CellContext`z$$, -0.11}, {$CellContext`z$$, -0.14}, \
{$CellContext`\[Mu]$$ + $CellContext`z$$ $CellContext`\[Sigma]$$, -0.14}, \
{$CellContext`\[Mu]$$ + $CellContext`z$$ $CellContext`\[Sigma]$$, -0.11}}]}]},
          PlotRange -> {{-7, 24}, {-0.15, 0.75}}, Axes -> {Automatic, False}, 
         ImageSize -> If[$CellContext`format$$ == True, 600, 480], 
         BaseStyle -> {
          FontSize -> If[$CellContext`format$$ == True, 18, 12]}]], 
      "Specifications" :> {{{$CellContext`\[Mu]$$, 15}, -2, 15, 1, Appearance -> 
         "Labeled"}, {{$CellContext`\[Sigma]$$, 2}, 0.6, 3, 0.1, Appearance -> 
         "Labeled"}, {{$CellContext`z$$, -1}, -3.4, 3.4, 0.01, Appearance -> 
         "Labeled"}, {{$CellContext`format$$, False, "large format"}, {
         False, True}}}, "Options" :> {AutorunSequencing -> {1, 2, 3}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{525., {226., 231.}},
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    RowBox[{"P", "(", 
     RowBox[{"Z", "\[LessEqual]", "z"}], ")"}]}], TraditionalForm]], 
  "InlineMath"],
 " where ",
 Cell[BoxData[
  FormBox["Z", TraditionalForm]], "InlineMath"],
 " is a standard normal random variable. Such probabilities are represented \
as areas to the left of ",
 Cell[BoxData[
  FormBox["x", TraditionalForm]], "InlineMath"],
 " or ",
 Cell[BoxData[
  FormBox["z", TraditionalForm]], "InlineMath"],
 " under a corresponding density curve.\n\nThis Demonstration provides a \
visualization of the relationship between a normal distribution ",
 Cell[BoxData[
  FormBox[
   RowBox[{"N", "(", 
    RowBox[{"\[Mu]", ",", "\[Sigma]"}], ")"}], TraditionalForm]], 
 ...
 Cell[BoxData[
  FormBox["z", TraditionalForm]], "InlineMath"],
 "\[Dash]score in a standard normal ",
 Cell[BoxData[
  FormBox[
   RowBox[{"N", "(", 
    RowBox[{"0", ",", "1"}], ")"}], TraditionalForm]], "InlineMath"],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"P", 
     RowBox[{"(", 
      RowBox[{"X", "\[GreaterEqual]", "x"}], ")"}]}], "=", 
    RowBox[{"P", "(", 
     RowBox[{"Z", "\[GreaterEqual]", "z"}], ")"}]}], TraditionalForm]], 
  "InlineMath"],
 "."
}], "ManipulateCaption",
 CellID->14400641],
...
Cell[TextData[{
 ButtonBox["Standard Normal Distribution",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/StandardNormalDistribution.html"], 
    None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
...
AreaOfANormalDistribution&version=0024"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/AreaOfANormalDistribution/\
AreaOfANormalDistribution-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\[NonBreakingSpace]",
 ButtonBox["Eric Schulz",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Eric+Schulz"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Eric+Schulz"]
}], "Author",
...
Cell[TextData[{
 "\"",
 ButtonBox["Area of a Normal Distribution",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/AreaOfANormalDistribution/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/AreaOfANormalDistribution/"],
 "\"",
 "\[ParagraphSeparator]\[NonBreakingSpace]",
 ButtonBox["http://demonstrations.wolfram.com/AreaOfANormalDistribution/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/AreaOfANormalDistribution/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/AreaOfANormalDistribution/"],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[45054, 842, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[45315, 851, 4388, 96, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[57076, 1127, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 83759, 1696},
 {"Copyright", 83954, 1701}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1278, 31, 34328, 567, 70, "DemonstrationHeader"],
Cell[35609, 600, 70, 1, 70, "DemoTitle",
 CellID->700863240],
Cell[35682, 603, 6508, 140, 70, "Output",
 CellID->572372273],
Cell[42193, 745, 2858, 95, 70, "ManipulateCaption",
 CellID->14400641],
Cell[45054, 842, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45315, 851, 4388, 96, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[49706, 949, 44, 0, 70, "RelatedLinksSection"],
Cell[49753, 951, 577, 20, 70, "RelatedLinks",
 CellID->101730388],
Cell[50333, 973, 598, 21, 70, "RelatedLinks",
 CellID->25503155],
Cell[50934, 996, 4814, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[55751, 1087, 45, 0, 70, "CitationSection"],
Cell[55799, 1089, 344, 11, 70, "Author",
 CellID->216851117],
Cell[56146, 1102, 927, 23, 70, "Citations"],
Cell[57076, 1127, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature lTEI3CItHa1U1xA1sLlddlln *)
