...
echo "Subject: Sundays Backup Run Finished - $DAY $DATE $LMONTH $YEAR"
echo
...
#Load the Sundays "2nd" tape to the drive (Load Slot 8 in Drive)
mtx -f /dev/sg2 load 8
...
echo "   <<< -------- WARNING !!!------- >>>"
echo
echo " Backed up to Tape in DLT Library Slot 8 (Sunday), Tape for tomorrow will be Slot 1 !!! "
echo
...
rm end-date
rm start-date
#Unload Sundays "2nd" Tape from the drive back to it's slot in the autoloader
mtx -f /dev/sg2 unload 8
