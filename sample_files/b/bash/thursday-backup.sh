...
echo "Subject: Thursdays Backup Run Finished - $DAY $DATE $LMONTH $YEAR"
echo
...
#Load the Thursdays tape to the drive (Load Slot 4 in Drive)
mtx -f /dev/sg2 load 4
...
echo "   <<< -------- WARNING !!!------- >>>"
echo
echo " Backed up to Tape in DLT Library Slot 4 (Thursday), Tape for tomorrow will be Slot 5 !!! "
echo
...
rm end-date
rm start-date
#Unload Thursdays Tape from the drive back to it's slot in the autoloader
mtx -f /dev/sg2 unload 4
